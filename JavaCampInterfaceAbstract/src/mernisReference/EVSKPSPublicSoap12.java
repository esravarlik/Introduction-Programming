...
public class EVSKPSPublicSoap12
{
    ...
    public EVSKPSPublicSoap12(){}

    public EVSKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public EVSKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        EVSExtendedSoapSerializationEnvelope envelope= new EVSExtendedSoapSerializationEnvelope(EVSExtendedSoapSerializationEnvelope.VER12);
