...
public class EVSExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(EVSDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new EVSStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static EVSDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static EVSDateTimeConverter dateTimeConverter = new EVSStandardDateTimeConverter();

    public EVSExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public EVSExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new EVSMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=EVSHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,EVSExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=EVSHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
