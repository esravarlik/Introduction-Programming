...
public class HDGExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HDGDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HDGStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HDGDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HDGDateTimeConverter dateTimeConverter = new HDGStandardDateTimeConverter();

    public HDGExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HDGExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HDGMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HDGHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HDGExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HDGHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
