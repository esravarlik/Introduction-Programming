...
public class HDGKPSPublicSoap
{
    ...
    public HDGKPSPublicSoap(){}

    public HDGKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HDGKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HDGExtendedSoapSerializationEnvelope envelope= new HDGExtendedSoapSerializationEnvelope(HDGExtendedSoapSerializationEnvelope.VER11);
